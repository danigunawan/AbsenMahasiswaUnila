...
public class ProfilActivity extends AppCompatActivity {
    ...
    TextView TextNpm,TextNama, TextNo_telp;// NPM, NAMA, NO TELP
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextNpm = (TextView) findViewById(R.id.nik);// ID NIK
    ...
    public void CekFotoProfile(final String user){
        ...
        crud.CekProfilMahasiswa(user, new Callback<Value>() {
            @Override
    ...
    public void MenampilkanFoto(Result result, String user, String value){
        ...
        TextNama.setText(result.getNamaMahasiswa());
        TextNpm.setText(user);
    ...
    // METHODE UMTUK MEMBUAT AGAR FOTO PROFILE JADI CIRCLE (BULAT)
    ...
    public void GantiFoto() {
        ...
        AlertDialog.Builder GantiFoto = new AlertDialog.Builder(ProfilActivity.this);
        // set title dialog
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == Activity.RESULT_OK) {
            ...
            // KEMBALI KE ACTIVITY ListJadwalActivity
            finish();
            startActivity(new Intent(ProfilActivity.this,ListJadwalActivity.class));
        }
    }
    ...
    private void ProsesUpdateProfile() {
        ...
        if (bitmap != null){
            ...
            CrudService crud = new CrudService();
            crud.UpdateProfil(encodedImage, user, new Callback<Value>() {
                @Override
                public void onResponse(Call<Value> call, Response<Value> response) {
    ...
    private void Berhasil(String user) {
        ...
        CekFotoProfile(user);
        Toast.makeText(ProfilActivity.this, "Foto Berhasil Di Ubah", Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        if (item.getItemId() == R.id.logout) {
            ...
            startActivity(new Intent(ProfilActivity.this, JadwalBesokActivity.class));
        } else if (item.getItemId() == R.id.jadwal_lusa) {
            startActivity(new Intent(ProfilActivity.this, JadwalLusaActivity.class));
